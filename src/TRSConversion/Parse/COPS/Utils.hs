...
import Text.Megaparsec (MonadParsec, between, empty, noneOf, notFollowedBy, satisfy, some, try, (<|>))
...
-- it ends with a closing parenthesis. (e.g, "(VAR x y z)" where "x y z" is consumed by p)
